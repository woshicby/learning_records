...
# print('retrieve_tree(1)的叶节点总数为：', get_num_leafs(retrieve_tree(1)))
# print('retrieve_tree(1)的树高为：', get_tree_depth(retrieve_tree(1)+1))
# create_plot(retrieve_tree(1))
# 正式绘图
print('生成树的叶节点总数为：', get_num_leafs(create_tree(myDat, Labels)))
print('生成树的树高为：', get_tree_depth(create_tree(myDat, Labels)+1))
