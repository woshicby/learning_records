...
# #####设置区域#####
sourceFile00 = r'D:\Desktop\新建文件夹\machinelearninginaction3x-master\Ch09\ex00.txt'
sourceFile0 = r'D:\Desktop\新建文件夹\machinelearninginaction3x-master\Ch09\ex0.txt'
...
# #####运行区域#####
print(create_tree(numpy.mat(load_data_set(sourceFile00))))
print(create_tree(numpy.mat(load_data_set(sourceFile0))))
