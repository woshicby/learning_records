...
turtle.penup()  # 抬起笔
turtle.goto(-400, 250)  # 把笔移动到-400,-100位置
turtle.pendown()  # 放下笔
turtle.pensize(1)  # 笔的粗细为1
level = 8
snow(level, 800)  # 绘制长度为800，阶为level的雪花曲线，方向水平
turtle.right(120)
snow(level, 800)  # 绘制长度为800，阶为level的雪花曲线，方向120
turtle.right(120)
snow(level, 800)  # 绘制长度为800，阶为level的雪花曲线，方向240
turtle.done()  # 保持绘图窗口
